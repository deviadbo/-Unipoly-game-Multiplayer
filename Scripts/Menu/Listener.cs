...
namespace AssemblyCSharp
{
	...
	{						
		...
		public delegate void ChatHandler(string _Sender, string _Message);
		public static event ChatHandler OnChatReceived;
		...
		public void onLeaveRoomDone (RoomEvent eventObj)
		{
			...
			if (OnUserLeftRoom != null)
				OnUserLeftRoom(eventObj.getData(), eventObj.getData().getId());
		}
		...
		{
			Debug.Log("<color=red>" + eventObj.getSender() + "</color>"  + " sended " + "<color=yellow>" + eventObj.getMessage() + "</color>") ;
			if (OnChatReceived != null)
				OnChatReceived(eventObj.getSender(), eventObj.getMessage());
